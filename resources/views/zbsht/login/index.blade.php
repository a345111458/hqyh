    ...
    <div class="layadmin-user-login-main">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <div class="layui-form-item">
                ...
                <input type="text" name="email" id="LAY-user-login-username" lay-verify="required" placeholder="用户名" class="layui-input">
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs5">
                        <div style="margin-left: 10px;">
                            <img src="{{ captcha_src('flat') }}" onclick="this.src ='/captcha/flat?'+Math.random() " class="layadmin-user-login-codeimg" id="captcha">
                        </div>
                    </div>
                </div>
            </div>
                ...
                success : function (res) {
                    if (res.status == 0) {
                        ...
                        layer.msg(res.msg,{icon:6},function(){
                            location.href = '{{ url('/zbsht/stroe') }}';
                        });
                    }
                },error : function (XMLHttpRequest) {
                    var parseJSON = XMLHttpRequest.responseJSON.errors;
                    var html = '';
