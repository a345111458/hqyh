    ...
    <div class="layui-side-scroll">
        ...
        <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
                ...
                <dl class="layui-nav-child">
                    <dd data-name="console" class="">
                        <a lay-href="{{ route('menu.index') }}">菜单管理</a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd data-name="console" class="">
                        <a lay-href="{{ route('config.index') }}">全局配置</a>
                    </dd>
                </dl>
            ...
            <li data-name="template" class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a lay-href="{{ route('member.index') }}">会员列表</a></dd>
                    <dd><a lay-href="{{ route('member.param.notExamile', 0 ) }}">未审会员</a></dd>
                    <dd><a lay-href="{{ route('member.param.notExamile', 1 ) }}">已审会员</a></dd>
                    <dd><a lay-href="{{ route('member.param.notExamile', 2 ) }}">冻结会员</a></dd>
                </dl>
            </li>

            <li data-name="template" class="layui-nav-item">
                <a href="javascript:;" lay-tips="提成管理" lay-direction="2">
                    <i class="layui-icon layui-icon-template"></i>
                    <cite>提成管理</cite>
                </a>
                <dl class="layui-nav-child">
                    <dd><a lay-href="{{ route('bonus.index') }}">提成设置</a></dd>
                </dl>
            </li>
            ...
            <li data-name="component" class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a lay-href="{{ route('cash.index') }}">提现报表</a></dd>
                </dl>
            </li>
