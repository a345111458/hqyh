           ...
           // 操作里的按钮
            table.on('tool()',function(obj){
                ...
                if (obj.event == 'del'){
                    ...
                    layer.open({
                        ...
                        maxmin: true, //开启最大化最小化按钮
                        area: ['600px', '500px'],
                        content:"/zbsht/bonus/" + field.id + '/edit',
                    });
                }
            });
            ...
            table.render({
                ...
                ,cols: [[
                    ...
                    ,{field:'name', title:'提成等级', width:160, edit: 'text'}
                    ,{field:'price', title:'奖金', width:180, edit: 'text'}
                    ,{field:'describe', title:'描述', width:120, edit: 'text'}
                    ,{field:'created_at', title:'添加时间', width:180,sort:true, edit: 'text'}
